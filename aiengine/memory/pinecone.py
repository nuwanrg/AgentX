...
from aiengine.llm_utils import create_embedding_with_ada
...
class PineconeMemory:
    def __init__(self, cfg):
        ...
        print("pinecone api key , pinecone_region", pinecone_api_key , pinecone_region)
        pinecone.init(api_key=pinecone_api_key, environment=pinecone_region)
        dimension = 1536
        metric = "cosine"
        pod_type = "p1"
        table_name = cfg.pinecone_memory_index
